...
<li class="popular-entry">
  ...
  <?php else: // サムネイルを持っていないときの処理 ?>
    <a href="<?php the_permalink(); ?>" class="popular-entry-title"><img src="<?php echo get_template_directory_uri(); ?>/img/no-image.gif" alt="NO IMAGE" title="NO IMAGE" width="75" height="75" /></a>
  <?php endif; ?>
